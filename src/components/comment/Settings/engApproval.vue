      ...
      <div class="md-2">
        <div class="content">
          <div class="content-top">
            <button type="button" class="mod-btn" style="background-color:#62b960;" @click="changetree('user')">
              <i class="mod-btn-icon fa fa-user" ></i>用户
            </button>
            <button type="button" class="mod-btn" style="background-color:#008080;" @click="changetree('status')">
              <img src="../../../icons/状态.png" height='12.73px' width='11.14px'></img>状态
            </button>
            <button type="button" class="mod-btn" style="background-color:#e7e8e8;color:#000000;" @click="changetree('class')">
              <img src="../../../icons/分类.png" height='12.73px' width='13px'></img>分类
            </button>
          </div>
...
export default {
  ...
  computed:{
    ...
    menuitem: function () {
      return this.$store.state.tree[3].children[3];
    },
   },
   watch:{
 ...
 mounted:function(){
    that = this;
    $.ajax({
      url:"get_user_approval_engineerings.php",
      type:"POST",
      dataType:"Json",
      data:{
        "id":'',
